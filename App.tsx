...
export default function App() {
  ...
  const handleEmojiSubmit = async () => {
    ...
    // Delay slightly so she can read the roast
    setTimeout(() => {
  ...
  return (
    <div className="relative w-full h-[100dvh] font-sans text-gray-800 overflow-hidden">
      ...
      {gameState === GameState.REVEAL && <Confetti />}

      {/* Main Container - Scrollable for mobile */}
      <div className="relative z-10 w-full h-full overflow-y-auto overflow-x-hidden">
        
        {/* Progress (Only show during missions) */}
          ...
          <div className="bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl p-8 max-w-md w-full border border-white/60 animate-float transition-all duration-500">
            ...
            {gameState === GameState.REVEAL && (
              <div className="text-center space-y-6 animate-in fade-in duration-1000">
                ...
                <h1 className="text-5xl font-handwriting text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-600 pb-2">
                  Happy Birthday!
                </h1>
